class Itinerary:
    ...
    def __init__(self, startTime, startStation, endStation, duration, numberOfTransfers, walkDistance, walkTime,distanceToStartStation, distanceFromEndStation, modes, routeNumbers):
